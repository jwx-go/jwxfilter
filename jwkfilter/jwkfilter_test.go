...
func TestFieldNameFilter(t *testing.T) {
	t.Run("ByName returns non-nil filter", func(t *testing.T) {
		...
		require.NotNil(t, fn, "ByName should return a non-nil filter")
	})
...
func TestECDSAStandard(t *testing.T) {
	const src = `{
		"kty": "EC",
		"crv": "P-256",
		...
		"x5c": [""],
		"x5t": "thumbprint",
